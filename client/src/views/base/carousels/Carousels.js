...
const Carousels = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <a name="Carousel" href="components/carousel" />
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/carousel">
              <CCarousel>
                <CCarouselItem>
                  <img className="d-block w-100" src={""} alt="slide 1" />
                </CCarouselItem>
                <CCarouselItem>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/carousel/#with-controls">
              <CCarousel controls>
                <CCarouselItem>
                  <img className="d-block w-100" src={""} alt="slide 1" />
                </CCarouselItem>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/carousel/#with-indicators">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/carousel/#with-captions">
              <CCarousel controls indicators>
                <CCarouselItem>
                  <img className="d-block w-100" src={""} alt="slide 1" />
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/carousel/#crossfade">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/carousel/#dark-variant">
