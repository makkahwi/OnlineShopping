...
const Buttons = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <a name="Button" href="components/buttons" />
      </CCol>
      <CCol xs={12}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/buttons#button-components">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/buttons#sizes">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <a href="components/buttons#pill-buttons">
              {[
                'primary',
                'secondary',
                'success',
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <a href="components/buttons#square">
              {[
                'primary',
                'secondary',
                'success',
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/buttons#block-buttons">
