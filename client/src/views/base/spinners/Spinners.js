...
const Accordion = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <a name="Spinner" href="components/spinner" />
      </CCol>
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/spinner#colors">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/spinner#growing-spinner">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/spinner#size">
              <CSpinner size="sm" />
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/spinner#buttons">
              <CButton disabled>
