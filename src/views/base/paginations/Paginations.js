...
const Paginations = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <a name="Pagination" href="components/pagination" />
      </CCol>
      <CCol xs={12}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/pagination#working-with-icons">
              <CPagination aria-label="Page navigation example">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/pagination#disabled-and-active-states">
              <CPagination aria-label="Page navigation example">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/pagination#sizing">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <a href="components/pagination#aligment">
